# db/seeds/full_reservations.rb
#
# 通常の db:seed では読み込まない大量デモデータ用 seed。
# 必要な場合だけ `bin/rails runner db/seeds/full_reservations.rb` で実行する。
